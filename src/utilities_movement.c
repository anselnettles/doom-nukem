...
void	delta_time_move(t_drown *data)
{
		...
		if (data->player.height < (data->map.map[(int)roundf((data->player.y - data->player.dy) / 64)][(int)roundf((data->player.x - data->player.dx) / 64)][0] - '0') * 32 + data->player.base_height
			|| data->map.map[(int)roundf((data->player.y - data->player.dy) / 64)][(int)roundf((data->player.x - data->player.dx) / 64)][0] == '#')
		{
			data->player.x += data->player.velocity.x * data->system.frame_time * data->player.dx;
			data->player.y += data->player.velocity.x * data->system.frame_time * data->player.dy;
		}
