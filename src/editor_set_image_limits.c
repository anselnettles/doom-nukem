...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: tturto                                   #+#    #+#             */
/*   Updated: 2023/02/19 14:33:46 by aviholai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	images->img1_x_min = WIDTH * 0.05;
	images->img2_x_min = WIDTH * 0.625; // 1280 * 0.625 = 800
	images->img1_x_max = images->img2_x_min - 1;
	images->img3_x_min = WIDTH * 0.78125; // 1280 = 0.78125 = 1000
	images->img2_x_max = images->img3_x_min - 1;
	images->img3_x_max = WIDTH;
	images->img_y_min = HEIGHT * 0.05;
	images->img_y_max = HEIGHT;
